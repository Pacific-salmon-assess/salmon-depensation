...
QDLogLike <- function(parms){
  ...
  predicted <- alpha*sim_stock$stock*exp(((beta*sim_stock$stock)-(delta*sim_stock$stock))^gamma) #CHECK
...
kable(cbind(c("Sk", "k", "c", "sd"), round(QD_fit$par, 2)))
```
